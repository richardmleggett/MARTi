...
var runKonsole = function (command, _a, terminalArgs) {
    if (_a === void 0) { _a = {}; }
    ...
    // console.log(args)
    var cmdProcess = child_process_1.spawn('konsole', args, __assign({ detached: detached,
        stdio: stdio,
        shell: shell }, restSpawnOptions));
    return cmdProcess;
};
exports.default = runKonsole;
// test
