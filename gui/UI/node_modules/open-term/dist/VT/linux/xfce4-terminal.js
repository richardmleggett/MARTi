...
var runXfce = function (command, _a, terminalArgs) {
    if (_a === void 0) { _a = {}; }
    ...
    var cwd = process.cwd();
    var args = ['--hold', '--working-directory', cwd];
    if (terminalArgs) {
    ...
    // console.log(args)
    var cmdProcess = child_process_1.spawn('xfce4-terminal', args, __assign({ detached: detached,
        stdio: stdio,
        shell: shell }, restSpawnOptions));
    return cmdProcess;
};
exports.default = runXfce;
// test
