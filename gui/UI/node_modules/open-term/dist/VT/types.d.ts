...
export declare type PlatformsList = (keyof typeof VT);
/**
 ...
 */
export declare type TerminalExecutor = (command: string, terminalSpawnOptions?: SpawnOptions, terminalArgs?: string[]) => ChildProcess;
